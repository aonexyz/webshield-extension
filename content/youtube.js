// webshield - YouTube Content Script
...
(function () {
    ...
    function removeMotivationQuote() {
        const el = document.querySelector('.web-shield-quote');
        if (el) el.remove();
    }
